...
type Service interface {
	...
	Create(payload *model.JwtPayload, req *schemas.RequestCategory) (int, interface{})
	Update(payload *model.JwtPayload, id string, req *schemas.RequestCategory) (int, interface{})
